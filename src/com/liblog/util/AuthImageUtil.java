...
public class AuthImageUtil {
	 ...
	 * @throws IOException 
	 */
	public static void getCode(HttpServletResponse response,HttpServletRequest request,String codeName) throws IOException{
		// 设置响应的类型格式为图片格式
        ...
        request.getSession().setAttribute(codeName, vCode.getCode());
        vCode.write(response.getOutputStream());
	}
	
	public static class CreateImageCode {
	    // 图片的宽度。
